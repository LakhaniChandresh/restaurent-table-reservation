...
<div class="container">
    <h3 class="text-center title-font"><br>New Reservation<br></h3>   
    <div class="row">
  ...
  //error handling:
    ...
    <div class="signup-form">
		...
		<label class="checkbox-inline"><input type="checkbox" required="required"> I accept the <a href="#">Terms of Use</a> &amp; <a href="#">Privacy Policy</a></label>
            ...
            <div class="form-group">
            <button type="submit" name="reserv-submit" class="btn btn-dark btn-lg btn-block sub-re-btn">Submit Reservation</button>
            </div>
        </form>
        <br><br>
    </div>
